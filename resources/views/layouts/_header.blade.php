        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li role="separator" class="divider"></li>
                        <li><a href="{{ route('stores.show',['store'=>\Illuminate\Support\Facades\Auth::user()]) }}" class=""><span class="glyphicon glyphicon-user"></span>&emsp;查看店铺信息</a></li>
                        <li><a href="{{ route('stores.pwd_edit',['store'=>\Illuminate\Support\Facades\Auth::user()]) }}" class=""><span class="glyphicon glyphicon-cog"></span>&emsp;修改密码</a></li>
                        <li role="separator" class="divider"></li>
                        <li>
